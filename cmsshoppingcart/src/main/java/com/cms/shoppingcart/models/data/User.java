...
public class User implements UserDetails {
	...
	public User(int id, @Size(min = 2, message = "Username must be 2 characters long") String username,
			@Size(min = 4, message = "Password must be 4 characters long") String password, String confirmPassword,
			@Email(message = "Please enter a valid email") String email,
			@Size(min = 10, message = "Phone number must be of 10 digits") String phoneNumber) {
		super();
		this.id = id;
